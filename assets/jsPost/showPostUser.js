    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-8 vstack gap-4">
                ...
                <div class="card">
                    <!-- Cover image -->
                    <a  href="#!" data-bs-toggle="modal" data-bs-target="#feedActionPhoto" >  <div class="h-200px rounded-top" style="background-image:url(/assets/images/bg/05.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;">
                        ...
                        <div class="d-sm-flex align-items-start text-center text-sm-start">
                            <div>
                                ...
                                <div class="avatar avatar-xxl mt-n5 mb-3">
                                    <a href="#!" data-bs-toggle="modal" data-bs-target="#feedActionVideo"> <img src="https://static2.yan.vn/YanNews/2167221/202003/dan-mang-du-trend-thiet-ke-avatar-du-kieu-day-mau-sac-tu-anh-mac-dinh-b0de2bad.jpg" class="avatar-img rounded-circle border border-white border-3"></a>
                                    <tbody id="show"></tbody>
                                </div>
                            </div>
...
<!--                                </div>-->
<!--                            </div>-->
<!--                            &lt;!&ndash; Card share action menu &ndash;&gt;-->
...
<!--                            </ul>-->
<!--                        </div>-->
<!--                        &lt;!&ndash; Card share action END &ndash;&gt;-->
<!--                    </div>-->
                    <!-- Card header START -->
